...
File file1 = new File( basedir, "target/avaje-agentloader-jar-in-jar-test-" + projectVersion + "-classname.jar" );
File file2 = new File( basedir, "target/avaje-agentloader-jar-in-jar-test-" + projectVersion + "-prefix.jar" );
